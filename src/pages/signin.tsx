...
const SignInBtn: React.FC<{ provider: { name: string; icon: JSX.Element; color: string } }> = (props) => {
  ...
  return (<button onClick={() => signIn(provider.name)} className={`${provider.color} text-white font-semibold py-4 px-14 rounded-md shadow-md transition-colors duration-300 mb-4 flex items-center text-xl`}>
    {provider.icon}
